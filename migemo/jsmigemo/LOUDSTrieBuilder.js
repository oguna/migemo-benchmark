...
class LOUDSTrieBuilder {
    static build(keys, generatedIndexes = undefined) {
        let memo;
        ...
        let bitVector = new BitVector_1.BitVector(bitVectorWords, bitVectorIndex);
        return new LOUDSTrie_1.LOUDSTrie(bitVector, new Uint16Array(edges));
    }
}
